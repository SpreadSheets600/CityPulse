      ...
      <div>
        ...
        >
          ...
          <button
            ...
            class="btn btn-primary rounded-xl font-bold px-5 shadow-lg shadow-blue-500/10 cursor-pointer"
          >
        ...
        >
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              ...
              <input
                ...
                placeholder="e.g. North Ward Zone A"
              />
            </div>
            <div>
              <label class="label"
            ...
            <div>
              ...
              >
              <input
                v-model.number="form.min_lat"
                type="number"
                step="any"
                class="input input-bordered w-full rounded-xl border-base-300 focus:border-primary font-mono text-xs"
              />
            </div>
            <div>
              <label class="label"
          ...
          <div class="mt-6">
            <button
              ...
              class="btn btn-accent rounded-xl font-bold px-6 cursor-pointer"
            >
              SAVE GEOFENCE RULE
            </button>
          </div>
              ...
              <tbody class="divide-y divide-base-300/40 text-base-content/90">
                ...
                >
                  ...
                  <td class="px-6 py-4 text-right">
                    <button
                      @click="deleteGeofence(f.id)"
                      class="text-error hover:text-red-400 text-xs font-mono cursor-pointer bg-transparent border-0"
                    >
                      DELETE
                    </button>
                  </td>
